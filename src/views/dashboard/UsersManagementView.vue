<template>
  <v-container fluid class="users-management-content">
    ...
    <v-row class="mb-6">
      <v-col cols="12">
        <v-card class="pa-4" elevation="2">
          <v-card-title class="text-h6">Filtros de Búsqueda</v-card-title>
            ...
            <v-row>
              <v-col cols="12" md="4">
                <v-text-field 
                  ...
                  hint="Busca por nombre o correo electrónico"
                  persistent-hint
                ></v-text-field>
              </v-col>
              <v-col cols="12" md="4">
                <v-select 
                  ...
                  hint="Selecciona un rol específico"
                  persistent-hint
                ></v-select>
              </v-col>
              <v-col cols="12" md="4" class="d-flex align-center">
                <v-btn color="primary" @click="aplicarFiltros" block>
    ...
    <v-row class="mb-6">
      <v-col cols="12">
        <v-card class="pa-4" elevation="2">
          <v-card-title class="text-h6">Consulta de Usuarios</v-card-title>
            ...
            <v-row>
              ...
              <v-col cols="12" md="4">
                <v-text-field
                  ...
                  hide-details
                  @keyup.enter="cargarDatos"
                  hint="Último ID a consultar"
                  persistent-hint
                ></v-text-field>
              </v-col>
              <v-col cols="12" md="4">
                <v-btn color="success" @click="cargarDatos" :loading="cargando" block>
          ...
          <v-card-text>
            ...
            <v-data-table 
              ...
              <template #item.index="{ index, item }">
                <!-- Para debugging, mostrar también el ID real -->
                <div>
                  {{ index + 1 }}
              ...
              <template #item.acciones="{ item }">
                <v-btn icon small color="success" @click="editarUsuario(item)" 
                       :disabled="item.selectedRol === item.Nombre"
                       v-tooltip="'Guardar cambio de rol'">
...
// URL base de la API
const apiBaseUrl = 'https://gymtoday12.com';
